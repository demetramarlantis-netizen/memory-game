...
# Once the name has been entered and submitted, an directions screen will appear, explaining to the user how to play the game. 
# There will be a start button that will begin the game. 
# Once the user has pressed the start button, the game should begin. 
#The screen should show 10 squares in two rows of 5, each square with a different color. The squares should remain visible for 1 second. 
...
#If the user then clicks the wrong the square, the program should display a message stating "incorrect" and the score should stay the same. 
#If the user gets to 5 points, the program should end the game and display a message that the user has won the game! 
